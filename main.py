...
def title():
    ...
    stdout.write("             "+Fore.LIGHTYELLOW_EX  +"║ "+Fore.LIGHTWHITE_EX   +"       Gmail:duongnghia1710@gmail.com   "+Fore.LIGHTYELLOW_EX  +"            ║\n")
...
##############################################################################################
def command():
    stdout.write(Fore.LIGHTRED_EX+"╔═══"+Fore.LIGHTRED_EX+"[""root"+Fore.LIGHTRED_EX+"@"+Fore.LIGHTRED_EX+"Muroku"+Fore.LIGHTRED_EX+"]"+Fore.LIGHTRED_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.LIGHTRED_EX)
    command = input()
